...
vanilla_parent = None
all_performance([k1_drop0, k1_drop1, k1_drop2, k1_drop3], real_parent, vanilla_parent, title="knn1")

all_performance([k3_drop0, k3_drop1, k3_drop2, k3_drop3], real_parent, vanilla_parent, title="knn3")

all_performance([k5_drop0, k5_drop1, k5_drop2, k5_drop3], real_parent, vanilla_parent, title="knn5")