...
from plot.box.paths_cartpole_finalPlots import *
...
def top_param():
    ...
    random = cart_rnd
    true = {"true": cart_true}
    #plot_compare_top(true, calibration, None, random, "cartpole-failures", "../img/finalPlots/cartpole/plot7/plot7_violinplot_testingtesting", right_ax=[], outer=30, res_scale=-1)
    plot_compare_top(true, calibration, None, random, "cartpole-failures", "../img/finalPlots/cartpole/plot7/plot7_violinplot_testingtesting", outer=30, res_scale=-1, ylim=[], ylabel="Number of failures", right_ax=[], plot='box')
