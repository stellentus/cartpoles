...
class DQN(BaseAgent):
    ...
    #     if self.planning_type == "random_ER":
    #         return self.b_control.get_filled_length()
    #     else:
    #         return self.b_control.get_filled_length(), self.model.get_len_protos()
