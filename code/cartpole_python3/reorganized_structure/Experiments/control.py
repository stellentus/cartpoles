...
class Experiment():
    ...
    def single_ep(self):
        ...
        if self.config.agent_params.decreasing_epsilon=="ep":
        ...
        while (not end_of_ep) and \
            ...
            if self.config.agent_params.decreasing_epsilon=="step":
                self.agent.epsilon = max(1.0 - 1.0/10000 * self.count_total_step, self.config.agent_params.epsilon)
